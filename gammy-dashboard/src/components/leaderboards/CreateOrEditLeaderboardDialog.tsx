import {useCreateLeaderboard, useUpdateLeaderboard,} from "@/lib/api/mutations";
                    ...
                    <SelectContent>
                        {
                            gameStats && gameStats.map(stat =>
                                <SelectItem value={stat.apiName ?? ""}
                                            key={stat.id}>{stat.displayName} - {stat.description}</SelectItem>
                            )
                        }
                    </SelectContent>
                </Select>
