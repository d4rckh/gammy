import { useAchievements, usePlayerAchievements, usePlayerParametersOverrides, usePlayerStats } from "@/lib/api/queries";
      ...
      <TableBody>
        {
          Object.keys(data).map(item =>
            <TableRow>
              ...
              <TableCell>
                {!achievements.data?.find(a => a.apiName == item)?.unlockExpression && <LockOrUnlockPlayerAchievementButton playerId={playerId} apiName={item} value={data[item]} />}
              </TableCell>
            </TableRow>
          )
        }
